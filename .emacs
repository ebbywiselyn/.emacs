...
(custom-set-variables
 ...
 '(desktop-clear-preserve-buffers
   (quote
    ("\\*scratch\\*" "\\*Messages\\*" "\\*server\\*" "\\*tramp/.+\\*" "\\*Warnings\\*" "\\*kafka\\*" "\\*consumer\\*" "\\*producer\\*" "\\*local-shell\\*" "\\*shell\\*" "\\*zookeeper\\*" "\\*celery-worker\\*" "\\*redis-server\\*" "\\*Python\\*")))
...
(global-set-key (kbd "C-x C-y") 'helm-projectile-find-file-dwim)
...
(global-set-key (kbd "<f7>") 'helm-locate)
